...
import com.apress.springrecipes.springweb.services.Customer;
import com.apress.springrecipes.springweb.services.CustomerService;
...
//    @ResponseStatus(value = HttpStatus.ACCEPTED)
    ...
    @ResponseBody
    @RequestMapping(value = "/customer/new", method = RequestMethod.POST ) //,    consumes = MediaType.APPLICATION_JSON_VALUE)
    public Customer createCustomer(@RequestBody Customer customer) {
        customerService.createCustomer(customer.getFirstName(), customer.getLastName(), new Date());
        return customer;
    }
