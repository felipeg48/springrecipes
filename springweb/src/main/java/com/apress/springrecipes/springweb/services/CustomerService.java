package com.apress.springrecipes.springweb.services;
...
public class CustomerService {
    ...
    public void updateCustomer(Integer id, String fn, String ln, Date signupDate) {
	try { 
	    if (signupDate == null) { 
		// Signupdate empty, this means it's a new customer
		createCustomer(fn,ln,new Date());		
	    } else { 
		// Update customer
		Customer customer = getCustomerById(id);
